"""
Django settings for Cheka project.
...
# Turn off while not in development mode
...
ALLOWED_HOSTS = ['chekaapp.herokuapp.com']
...
WSGI_APPLICATION = 'Cheka.wsgi.application'
